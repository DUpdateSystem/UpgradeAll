...
Map mark/ignore version state when possible.
...
The host-side CLI implementation currently accepts a deterministic JSON bridge bundle instead of reading Room directly:
