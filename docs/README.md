...
15. `lua-api/` — practical Lua package authoring docs, including offline `repo validate` diagnostics.
16. `migration/legacy-room-mapping.md` — old data mapping rules.
17. `app/flutter-ui-feature-parity-and-testing.md` — Flutter feature parity and BDD/TDD test boundary.
18. `implementation/coding-agent-handoff.md` — coding-agent / pi-agent handoff instructions.
