...
val MIGRATION_6_7 = object : Migration(6, 7) {
    override fun migrate(database: SupportSQLiteDatabase) {
        ...
        with(database.query("SELECT * FROM repodatabase")) {
            while (moveToNext()) {
                ...
                if (type == "applications") {
                    ...
                    try {
                        val invalidPackageListJson = extraData?.getJSONObject("applications_config")?.getJSONArray("invalid_package_name")!!
                        val json = JSONArray()
                    ...
                    try {
                        val ignoreAppsJson = extraData?.getJSONObject("applications_config")?.getJSONArray("ignore_apps")!!
                    ...
                    val ignoreVersionNumberString = if (ignoreVersionNumber != null) "'$ignoreVersionNumber'" else null
        ...
        UIConfig.uiConfig.changeAppDatabaseId(databaseIdMap)
