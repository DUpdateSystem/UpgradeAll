...
import net.xzos.upgradeall.utils.install.ApkSystemInstaller
...
class ApkInstallerService : Service() {
    ...
    companion object {
        internal const val TAG = ApkSystemInstaller.TAG
        internal val logObjectTag = ApkSystemInstaller.logObjectTag
    }
}
