...
class DownloadListAdapter(dataList: List<DownloadItem>, appDetailViewModel: AppDetailViewModel)
    : DialogListAdapter<DownloadItem, DownloadItemHandler, DownloadHolder>(dataList, DownloadItemHandler(appDetailViewModel),
        fun(layoutInflater, viewGroup) = DownloadHolder(ItemDownloadDialogBinding.inflate(layoutInflater, viewGroup, false))
)