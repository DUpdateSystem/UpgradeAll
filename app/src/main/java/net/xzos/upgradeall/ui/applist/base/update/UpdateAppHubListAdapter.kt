...
class UpdateAppHubListAdapter(
    listContainerViewConvertFun: (App) -> UpdateAppListItemView,
    ...
    override val handler: UpdateAppHubListItemHandler = UpdateAppHubListItemHandler(scope)
